...
module.exports = function OneColBottomImg(props, context) {

  return (
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
      <tr>
        <td bgcolor={background(props.pos)} align="center" style="padding: 70px 15px 0 15px;" class="section-padding-bottom-image">
